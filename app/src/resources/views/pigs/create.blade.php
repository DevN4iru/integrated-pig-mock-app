    ...
    <div class="pig-create-layout">
        ...
        <form method="POST" action="{{ route('pigs.store') }}">
            ...
            <div class="form-grid">
                ...
                <div class="form-group purchase-cost-card" id="purchase_cost_group" style="display: none; border-color: #86efac; background: linear-gradient(180deg, #f0fdf4 0%, #ecfdf5 100%); box-shadow: 0 0 0 1px rgba(34, 197, 94, 0.18), 0 12px 26px rgba(34, 197, 94, 0.10);">
                    ...
                    <input id="purchase_cost" name="purchase_cost" type="number" step="0.01" min="0" value="{{ old('purchase_cost') }}">
        ...
        <aside class="panel-card pig-create-guide">
            ...
            <div class="pig-guide-list">
                ...
                <div class="pig-guide-item" style="border-color: #86efac; background: linear-gradient(180deg, #f0fdf4 0%, #ecfdf5 100%);">
                    <strong>Purchase Cost</strong>
                    <span>Shown only for purchased pigs. This is a reference cost and is not deducted from Net Position.</span>
                </div>
