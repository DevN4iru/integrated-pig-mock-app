...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <form method="POST" action="/pigs/update">
                ...
                <select id="pen_location" name="pen_location" required>
                    <?php foreach (['Fattening Pen 1','Fattening Pen 2','Fattening Pen 3','Fattening Pen 4','Fattening Pen 5','Fattening Pen 6','Sow Pen 1','Sow Pen 2'] as $pen): ?>
