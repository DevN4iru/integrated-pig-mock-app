...
<head>
    ...
    <title>Create Mortality Record</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <form method="POST" action="/mortality/store">
                <input type="hidden" name="pig_id" value="<?= htmlspecialchars((string) $mortality['pig_id']) ?>">

                <label for="date">Date</label>
                <input type="date" id="date" name="date" value="<?= htmlspecialchars($mortality['date']) ?>">

                <label for="cause">Cause</label>
                <input type="text" id="cause" name="cause" value="<?= htmlspecialchars($mortality['cause']) ?>">

                <label for="notes">Notes</label>
                <textarea id="notes" name="notes"><?= htmlspecialchars($mortality['notes']) ?></textarea>
